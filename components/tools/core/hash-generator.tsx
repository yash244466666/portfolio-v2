...
function md5(input: string): string {
  ...
  // Using a basic approach since Web Crypto doesn't support MD5
  function md5cycle(x: number[], k: number[]) {
    ...
    b = hh(b, c, d, a, k[10], 23, -109473440)
    ...
    c = ii(c, d, a, b, k[14], 15, -1416477638)
    ...
    c = ii(c, d, a, b, k[6], 15, -1560144370)
...
export default function HashGenerator() {
  ...
  return (
    <div className="space-y-6">
      ...
      <Button onClick={generate} disabled={loading || !input} className="w-full">
