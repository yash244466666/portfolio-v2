...
const GRID_CONFIG = {
  n: 20, // Grid density (optimized for performance)
...
const COLOR_PALETTES = [
  [0x0066ff, 0x33ccff, 0xffffff], // Blue theme
  [0xff3366, 0xff6699, 0xffffff], // Red theme
  [0x33ff66, 0x66ff99, 0xffffff], // Green theme
  [0xff6633, 0xff9966, 0xffffff], // Orange theme
  [0x9933ff, 0xcc66ff, 0xffffff], // Purple theme
]
...
export default function Smooth3DBackground() {
  ...
  useEffect(() => {
    ...
    const handleClick = (e: MouseEvent) => {
      ...
      // Trigger color and light randomization
